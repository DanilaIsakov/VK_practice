...
5. **Документы для сдачи**: описание проекта, подробное описание решения, model card; опционально презентация.
...
## Критерии успеха (соответствие требованиям задания)

- [x] Проект описан: цель, задачи, ожидаемые результаты
- [x] Используются открытые данные VK (deepvk), указано как именно
- [x] Есть материалы с описанием обученной модели
- [x] Приложен файл с подробным описанием решения
- [x] (Опционально) презентация актуальности и жизнеспособности модели
